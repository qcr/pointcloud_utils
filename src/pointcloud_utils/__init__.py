...
# This is taken from https://github.com/felixchenfy/open3d_ros_pointcloud_conversion/blob/master/lib_cloud_conversion_between_Open3D_and_ROS.py
def pointcloud2_to_pcd(pointcloud2: PointCloud2):
